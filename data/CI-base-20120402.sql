...
-- Sortzeko denbora: 2012-04-03, 00:09:24
...
--
-- Taularen egitura taula honentzat:  `motak`
--

CREATE TABLE IF NOT EXISTS `motak` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `izena` varchar(255) NOT NULL,
...
--
-- Taula honen datuak irauli `motak`
--

INSERT INTO `motak` (`id`, `izena`, `createad`, `updated`, `deleted`) VALUES
(1, 'admin', '2012-04-02 17:04:33', NULL, NULL),
(2, 'erabiltzailea', '2012-04-02 17:04:33', NULL, NULL);
